...
import notificationMiddleware from "src/redux/modules/notifications/middleware";
import driveMiddleware from "src/redux/modules/drive/middleware";
import commentsMiddleware from "src/redux/modules/comments/middleware/websockets";
import soundsMiddleware from "src/redux/modules/sounds/middleware";
import rootEpic from "./epics";
import rootReducer from "./modules";

function configureStore(preloadedState?: Object = {}): Object {
  const middleware: Array<Store<RootReducerState, GlobalFSA<*>>> = [
