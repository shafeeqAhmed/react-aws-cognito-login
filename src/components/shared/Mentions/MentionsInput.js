...
class MentionsInput extends React.Component {
  ...
  getInputProps = isTextarea => {
    ...
    const props = omit(this.props, "style", keys(propTypes));
  ...
  renderSuggestionsOverlay = () => {
    ...
    const suggestionsNode = (
      <SuggestionsOverlay
        ...
        suggestionsStyle={this.props.suggestionsStyle}
      />
    );
  ...
  updateSuggestionsPosition = () => {
    ...
    const suggestions = ReactDOM.findDOMNode(this.suggestionsRef);
